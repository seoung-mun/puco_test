...
export default function CommonBoardPanel({ board, playerNames, numPlayers, phase, onSelectRole, onSettlePlantation, canPickQuarry, canUseHacienda, onUseHacienda }: Props) {
